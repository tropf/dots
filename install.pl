...
my $template_filename = $dirname . "/zshrc.inc";
my $rc_included_filename = $dirname . "/zshrc";
my $rc_actual_filename = $homedir . "/.zshrc";
my $comment_filename = $dirname . "/zshrc.comment";
